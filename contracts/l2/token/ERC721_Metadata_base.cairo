...
from contracts.l2.token.ERC721_base import (
    _exists
)
...
from contracts.l2.utils.ShortString import uint256_to_ss
from contracts.l2.utils.Array import concat_arr
...
@storage_var
func ERC721_token_uri(index: felt,token_id :Uint256) -> (res: felt):
end
...
func _ERC721_Metadata_TokenURI{
    ...
    let (base) = ERC721_token_uri.read(token_uri_len,token_id)
    assert [token_uri] = base
    _ERC721_Metadata_TokenURI(token_uri_len=token_uri_len - 1, token_uri=token_uri + 1,token_id=token_id)
    return ()
end
...
func ERC721_Metadata_setTokenURI{
    ...
    _ERC721_Metadata_setTokenURI(token_uri_len, token_uri,token_id)
    ERC721_token_uri_len.write(token_id=token_id,value=token_uri_len)
    return ()
end
...
func _ERC721_Metadata_setTokenURI{
    ...
    ERC721_token_uri.write(index=token_uri_len,token_id=token_id, value=[token_uri])
    _ERC721_Metadata_setTokenURI(token_uri_len=token_uri_len - 1, token_uri=token_uri + 1,token_id = token_id)
    return ()
end

func Metadata_tokenURI{
        syscall_ptr: felt*,
        pedersen_ptr: HashBuiltin*,
        range_check_ptr
    }(token_id: Uint256) -> (token_uri_len: felt, token_uri: felt*):
    ...
    _ERC721_Metadata_TokenURI(token_uri_len, token_uri,token_id)
