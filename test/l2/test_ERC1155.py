...
async def erc1155_factory():
    ...
    erc1155 = await starknet.deploy(
        ...
        constructor_calldata=[
            ...
            int.from_bytes("eip155".encode("ascii"), 'big'), 1, int.from_bytes("erc1155".encode(
...
async def test_constructor(erc1155_factory):
    ...
    assert execution_info.result.res.blockchain_namespace == (
        blockchain_namespace,)
    assert execution_info.result.res.blockchain_reference == (
